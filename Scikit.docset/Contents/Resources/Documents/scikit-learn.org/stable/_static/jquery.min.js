...
<p>1. <b>Server:</b> scikit-learn.org
<br />2. <b>URL path:</b> /stable/_static/jquery.min.js
<br />3. <b>Error notes:</b> NONE
<br />4. <b>Error type:</b> 404
<br />5. <b>Request method:</b> GET
<br />6. <b>Request query string:</b> NONE
<br />7. <b>Time:</b> 2014-05-15 06:19:06 UTC (1400134746)
...
<ol><li>Contact the project via their <a href="http://sourceforge.net/support/prweb-lookup.php?host=scikit-learn.org&support=1">designated support resources</a>.
<li>Contact the project administrators of this project via email (see the upper right-hand corner of the <a href="http://sourceforge.net/support/prweb-lookup.php?host=scikit-learn.org">Project Summary page</a> for their usernames) at <i>user-name</i>@users.sourceforge.net</ol>
